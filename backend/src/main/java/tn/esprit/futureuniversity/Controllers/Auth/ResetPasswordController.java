package tn.esprit.futureuniversity.Controllers.Auth;

import lombok.AllArgsConstructor;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import tn.esprit.futureuniversity.DTO.ChangePasswordRequest;
import tn.esprit.futureuniversity.DTO.ResetPasswordRequest;
import tn.esprit.futureuniversity.Entities.User;
import tn.esprit.futureuniversity.Repositories.UserRepository;
import tn.esprit.futureuniversity.Services.EmailService;
